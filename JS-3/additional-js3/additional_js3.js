...
// let numbs = [8, 9, 12, 5, 14, 16, 99, 60, 35];
// let i = 0;
...
// let numbs = [8, 9, 12, 5, 11, 7, 99, 60, 35];
// let numb = [];
// let i = 0;
// while (i < numbs.length) {
//     let numb = numbs[i];
...
//
// document.write(`<ol>`)
// for (let usersWithCitie of usersWithCities) {
...
//     <div class="address-block"> <p>${usersList[i].address.city}</p> <p>${usersList[i].address.street}</p> <p>${usersList[i].address.suite}</p> <p>${usersList[i].address.zipcode}</p></div>
//     ${usersList[i].address.geo.lat} ${usersList[i].address.geo.lng} ${usersList[i].id} ${usersList[i].website} <br> ${usersList[i].company.name}
//     ${usersList[i].company.catchPhrase} ${usersList[i].company.bs}</div>`)
// }
// document.write(`</div>`);
...
// for (let i = 0; i < usersList.length; i++) {
//     const usersListElement = usersList[i];
//     document.write(`<div class="post-card"> ${usersList[i].userId}<br/><h3>${usersList[i].id}</h3> <h3>"${usersList[i].title}" </h3> <p>${usersList[i].body}</p>
//     </div>`)
// }
// document.write(`</div>`);